import { IconHome, IconClipboardList, IconCreditCard, IconBarChart2, IconAccounting, IconCalendar } from '../components/icons';
...
export const TABS = [
  ...
  { id: 'monthlyReport', label: 'Monthly', mobileLabel: 'Month', icon: IconCalendar },
